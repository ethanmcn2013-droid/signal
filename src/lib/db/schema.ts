...
export const userPreferences = sqliteTable(
  ...
  (t) => [
    // The daily cron filters WHERE cadence = ? AND (last_sent_at IS
    // NULL OR last_sent_at < ?). Composite index keeps that off a
    // full table scan as the subscriber table grows.
