...
/**
 * Lab switcher — a quiet top bar to move between the 4 Signal hero options and
...
export function LabSwitcher({ activeSlug }: { activeSlug: string }) {
  ...
  return (
    <nav className="lab-bar" aria-label="Signal hero options">
      <Link href="/lab" className="lab-home">Signal · hero lab</Link>
