...
const SOCIALS = [
  { label: "X", href: "https://x.com/signalstudio_ie", title: "Signal Analytics on X",
  ...
  { label: "YouTube", href: "https://www.youtube.com/@signalstudio_ie", title: "Signal Analytics on YouTube",
  ...
  { label: "TikTok", href: "https://www.tiktok.com/@signalstudio_ie", title: "Signal Analytics on TikTok",
    svg: (<svg viewBox="0 0 24 24" width="14" height="14" fill="currentColor" aria-hidden><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5.8 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1.84-.1z" /></svg>) },
  { label: "LinkedIn", href: "https://www.linkedin.com/company/signal-studio-ie", title: "Signal Analytics on LinkedIn",
    ...
    <footer className="mt-32 border-t border-border-soft pb-10 pt-16">
      ...
      <div className="mx-auto mt-12 flex w-full max-w-[1240px] flex-col items-start justify-between gap-2 border-t border-border-soft px-6 pt-6 text-[12px] text-ink-quiet md:flex-row md:items-center">
        ...
        <div className="flex items-center gap-4">
          ...
          <nav aria-label="Signal Analytics on social" className="flex items-center gap-0.5">
            {SOCIALS.map((s) => (
              <a
                key={s.label}
                href={s.href}
